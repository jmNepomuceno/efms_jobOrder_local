...
try {
    $sql = "UPDATE job_order_request SET requestStatus='Pending Materials', processedBy=?, requestPendingMaterialsDate=?, requestPendingMaterials=?, processedByID=? WHERE requestNo=?";
