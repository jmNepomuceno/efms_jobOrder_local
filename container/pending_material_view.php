<div class="pending-material-view">
    <h1>Integrated Hospital Operations and Management Program</h1>
    <div class="table-container">
        <table id="pending-material-dataTable">
            <thead>
                <tr>
                    <th>JOB ORDER NO.</th>
...
<div class="modal fade" id="modal-view-pendingMaterials-form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div id="modal-body-incoming" class="modal-body-incoming ml-2">
                ...
                <div class="tech-assessment-section">
                    <h5 class="info-heading">Technician Pending Materials Details</h5>
